...
$query = "SELECT id, email, username, created_at, is_restricted
          FROM admin  
...
if (isset($_POST['toggle_restriction'])) {
    ...
    // Update the database
    $update_query = "UPDATE admin SET is_restricted = ? WHERE id = ?";
    $stmt = $conn->prepare($update_query);
    $stmt->bind_param("ii", $new_status, $admin_id);
    $stmt->execute();

    // Redirect to refresh the page
    header("Location: superAdminAdmins.php");
    exit();
}
?>
...
<body>
    ...
    <div class='container-fluid'>
        <div class='row'>
            ...
            <div class='col-9'>
                <h2 class='mx-5 mt-5 white'>Admin</h2>
                <div id="mainPage">
                                    ...
                                    <?php while ($row = $result->fetch_assoc()): ?>
                                        <tr>
                                            ...
                                            <td class="action-buttons">
                                                ...
                                                <input type="button" id="btnMoreInfo" value="More Info.">
